...
def main():
    ...
    samples = signal.lfilter(filt, 1, samples)  # type: ignore
    samples = signal.hilbert(samples)  # type: ignore
    sig1 = samples[1:]
    ...
    _, properties = signal.find_peaks(baud_detect, 2750, plateau_size=(None, None))
    peaks_unrefined = properties["left_edges"]  # type: ignore
